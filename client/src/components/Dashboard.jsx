...
const Dashboard = () => {
  ...
  const getUser = async () => {
    try {
      const response = await axios.get("https://taskify-five-self.vercel.app/login/success", {
  ...
  const getTasks = async (userId) => {
    try {
      const response = await axios.get(`https://taskify-five-self.vercel.app/tasks/${userId}`);
  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.post("https://taskify-five-self.vercel.app/tasks", {
        task: inputValue,
        id: userData._id,
      });
  ...
  const toggleTaskStatus = async (taskId, currentStatus) => {
    try {
      ...
      await axios.post("https://taskify-five-self.vercel.app/tasks/update-status", {
        taskId,
        newStatus,
      });
  ...
  const deleteTask = async (taskId) => {
    try {
      await axios.delete(`https://taskify-five-self.vercel.app/tasks/${taskId}`);
